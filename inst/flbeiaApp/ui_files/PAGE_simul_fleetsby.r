            ...
            tabPanel(
              ...
              fluidRow(
                ...
                column(3,
                  ...
                  selectizeInput("indicatorFby", label=h4("Indicator"), unique(fltStk$indicator), selected="catch",                 multiple=T, options=list(plugins=list("remove_button", "drag_drop"))),
     ...
     tabPanel(
       ...
       fluidRow(
         ...
         column(3,
                ...
                selectizeInput("stockbyA",     label=h4("Stock"),      unique(fltStk$stock), selected=unique(fltStk$stock),   multiple=T, options=list(plugins=list("remove_button", "drag_drop"))),
