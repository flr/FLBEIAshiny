...
tabsetPanel(type = "tabs",
           ...
           #             selectizeInput("fleetbyA",     label=h4("Fleet"),      unique(fltStk$fleet), selected=unique(fltStk$fleet)[1],multiple=F, options=list(plugins=list("remove_button", "drag_drop"))),
           #             selectizeInput("stockbyA",     label=h4("Stock"),      unique(fltStk$stock), selected=unique(filter(fltStk, fleet == unique(fltStk$fleet)[1])$stock)[1],multiple=T, options=list(plugins=list("remove_button", "drag_drop"))),
