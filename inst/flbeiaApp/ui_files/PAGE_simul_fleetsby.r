            ...
            tabPanel(
              ...
              fluidRow(
                ...
                column(3,
                       ...
                       selectizeInput("fleetbyA", label=h4("Fleet"), levels(as.factor(fltStk$fleet)), selected=levels(as.factor(fltStk$fleet))[1],multiple=T, options=list(plugins=list("remove_button", "drag_drop"))),
