    ...
    tabPanel( 
        ...
        fluidRow(
            ...
            column(3,
                  ...
                  numericInput('nColFSPby', h5("N.Col in facets"), value = 2, min = 1, max = 10, step = 1, width = 100)#hr(),
                  ),
                  shinyBS::bsCollapsePanel("Download",
                       # Options for file downloading
                       textInput('filenmFSPby', h5("File Name"), value = "", width = NULL, placeholder = NULL),
                       numericInput('fileWFSPby', h5("Width (cm)"), value = 14, min = 0, max = 25, step = 1, width = 100),
                       numericInput('fileHFSPby', h5("Height (cm)"), value = 10, min = 0, max = 25, step = 1, width = 100),
                       numericInput('fileScFSPby', h5("Scale in ggsave"), value = 1.5, min = 0, max = 3, step = 0.1, width = 100),
                       selectInput(inputId = "fileTypeFSPby", label = "Select the file type", selected= "png", choices = c("eps", "ps", "pdf", "jpeg", "tiff", "png", "bmp", "svg", "wmf"), multiple = FALSE),
